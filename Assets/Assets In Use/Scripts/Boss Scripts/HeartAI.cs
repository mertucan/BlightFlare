...
public class HeartAI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // ← YENİ: Activate() çağrılana kadar collider'ı kapat
    ...
    private MaskAI maskAI; // ← YENİ

    public void SetBossRoomTrigger(BossRoomTrigger trigger)
    {
        // Kept for BossRoomTrigger compatibility. Door unlocking is handled by RoomEnemyTracker.
    }

    public void SetMaskAI(MaskAI mask)
    {
        maskAI = mask;
    }
